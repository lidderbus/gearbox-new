...
export const azimuthThrusters = [
  ...
  },
  {
    ...
    series: "LP",
    type: "l-drive",
    description: "L形传动全回转推进器，中功率型",
    powerRange: [500, 750],
    thrust: { continuous: 105, bollard: 130 },
    propellerDiameter: [1.5, 2.0],
    inputSpeedRange: [800, 1500],
    ratios: [2.5, 3.0, 3.5, 4.0],
    rotationAngle: 360,
    rotationSpeed: 2.0,
    efficiency: 0.87,
  ...
  },
  {
    ...
    series: "LP",
    type: "l-drive",
    description: "L形传动全回转推进器，大功率型",
    powerRange: [750, 1000],
    thrust: { continuous: 140, bollard: 170 },
    propellerDiameter: [1.7, 2.3],
    inputSpeedRange: [700, 1400],
    ratios: [3.0, 3.5, 4.0, 4.5],
    rotationAngle: 360,
    rotationSpeed: 1.8,
    efficiency: 0.87,
    weight: 7500,
    dimensions: "2100x1900x3200",
    immersionDepth: 2800,
    applications: ["港作拖轮", "AHTS", "工程船"],
    propellerType: ["FPP", "CPP"],
    basePrice: 1080000,
    discountRate: 0.12,
    factoryPrice: 950400,
